...
Delete backend/routes/vectorize.ts
Remove vectorize binding from wrangler.jsonc
Remove from vite.config.ts cloudflare plugin
Remove route registration in backend/src/index.ts
Add New API Routes
